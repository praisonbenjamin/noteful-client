...
class AddNote extends React.Component {
    ...
    handleSubmit = e => {
        ...
        fetch('https://pacific-forest-89244.herokuapp.com/api/note', {
            method: 'POST',
            ...
            .then(response => {
                if (!response.ok) {
                    throw new Error('There was an error creating note. Please try again!')
                }
            ...
            <div className='AddNote'>
                <form className='addNoteForm' onSubmit={e => this.handleSubmit(e)}>
                    <fieldset>
                        ...
                        <label htmlFor='targetFolder'>Select Folder</label>
                        <br></br>
